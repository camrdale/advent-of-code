...
class Part2(Part):
    def run(self, parser: InputParser) -> int:
        ...
        log(INFO, 'Found the last bingo at turn:', max_first_bingo)
        log(DEBUG, 'Last bingo is in card:', [call_order[order] for order in max_bingo_card])
        ...
        log(RESULT, 'Score for last card to bingo is:', score)
        return score


part = Part2()

part.add_result(1924, """
