...
from .shared import Operation, LogicEquation, calculate_z
...
class Part1(Part):
    def run(self, parser: InputParser) -> int:
        ...
        for line in logic_input:
            ...
            equations[result] = LogicEquation.deterministic(lhs, Operation[operation], rhs)
        
        z = calculate_z(known_bits, equations)
        log(RESULT, f'Decimal number on z wires: {z}')
        return z
...
part.add_result(54715147844840)
